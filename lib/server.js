...
function startServer(config) {
  ...
  app.get('/render', (req, res) => {
    ...
    try {
      ...
      if (query.layoutWidth) activeBlogMeta['select:Layout Width'] = query.layoutWidth;
      if (query.syntaxTheme) activeBlogMeta['select:Syntax Highlight theme'] = query.syntaxTheme;
      if (query.endlessScroll) activeBlogMeta['if:Endless Scroll'] = query.endlessScroll;
      if (query.disqusShortname) activeBlogMeta['text:Disqus Shortname'] = query.disqusShortname;
      if (query.themeVersion) activeBlogMeta['text:Theme Version'] = query.themeVersion;
      if (query.gaId) activeBlogMeta['text:Google Analytics ID'] = query.gaId;
