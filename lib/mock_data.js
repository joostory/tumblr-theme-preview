...
const defaultPostNotesHTML = `<ol class="notes"><!-- START NOTES --><li class="note like tumblelog_dbwhddn78 without_commentary"><a rel="nofollow" class="avatar_frame" target="_blank" href="https://dbwhddn78.tumblr.com/" title="제목 없음 "><img src="https://assets.tumblr.com/images/default_avatar/octahedron_open_16.png" class="avatar " alt=""></a><span class="action"><a rel="nofollow" href="https://dbwhddn78.tumblr.com/" title="제목 없음">dbwhddn78</a>님이 좋아합니다.                                    </span><div class="clear"></div></li><li class="note reblog tumblelog_joostory original_post with_commentary"><a rel="nofollow" class="avatar_frame" target="_blank" href="https://joo.joohana.net/" title="Joo"><img src="https://64.media.tumblr.com/avatar_969648a3dc30_16.pnj" class="avatar " alt=""></a><span class="action" data-post-url="https://joo.joohana.net/post/761686932452425728"><a rel="nofollow" href="https://joo.joohana.net/" class="tumblelog" title="Joo">joostory</a>님이 포스팅했습니다.                                                                        </span><div class="clear"></div><blockquote><a rel="nofollow" href="https://joo.joohana.net/post/761686932452425728" title="포스트 표시">
                                주말에 혼자 있을때 도서관에서 책을 읽곤하는데 성남시 도서관을 돌아다니면서 책을 읽어보려고 했다. 8월 마지막날 구미도서관에서 우연히 스탬프투어를 한다는 것을 알게 되었다. 그렇게 나의 도서관 스탬프 투어가...                            </a></blockquote></li><!-- END NOTES --></ol>`;
...
function getMergedMockData(staticPath) {
  ...
  // 각 포스트에 PostNotes 및 NoteCount 기본값 보강
  posts = posts.map(post => {
    return {
      PostNotes: defaultPostNotesHTML,
      NoteCount: 2,
      ...post
    };
  });
